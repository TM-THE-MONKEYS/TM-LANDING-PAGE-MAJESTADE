    ...
    >
      <div className="flex items-center justify-between transition-all duration-300 px-2 pl-5 py-2">
        ...
        <div className="hidden items-center gap-6 md:flex">
          <Link
            href="#contato"
            className={`px-4 py-2 text-sm font-medium transition-all rounded-full ${isScrolled ? "bg-accent text-accent-foreground hover:opacity-90" : "bg-white text-foreground hover:bg-white/90"}`}
          >
            Solicitar orçamento
          </Link>
        </div>
